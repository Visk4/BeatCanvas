                    ...
                    <div className="relative bg-slate-900/80 backdrop-blur-xl border border-white/10 rounded-2xl p-8 shadow-2xl">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-5">
                            ...
                            >
                                ...
                                <div className="relative group">
                                    ...
                                    <Input
                                        ...
                                        className="pl-11 bg-slate-800/50 border-white/10 text-white placeholder:text-gray-500 focus:border-white/30 focus:ring-2 focus:ring-white/10 transition-all h-12 rounded-xl"
                                    />
                                </div>
                            </motion.div>
                            ...
                            >
                                ...
                                <div className="relative group">
                                    ...
                                    <Input
                                        ...
                                        required
                                        placeholder="••••••••"
                                        className="pl-11 pr-11 bg-slate-800/50 border-white/10 text-white placeholder:text-gray-500 focus:border-white/30 focus:ring-2 focus:ring-white/10 transition-all h-12 rounded-xl"
                                    />
                                    <button
                                        type="button"
                            ...
                            >
                                <Button
                                    type="submit"
                                    disabled={loading}
                                    className="w-full h-12 bg-white hover:bg-gray-200 text-black font-semibold rounded-xl transition-all duration-300 group relative overflow-hidden"
                                >
                        ...
                        >
                            <div className="relative">
                                ...
                                <div className="relative flex justify-center text-xs uppercase">
                                    <span className="bg-slate-900/80 px-2 text-gray-500">Or continue with</span>
                                </div>
                            </div>

                            <button
                                onClick={() => window.location.href = 'http://localhost:8000/api/v1/auth/google'}
                                className="mt-4 w-full h-12 bg-white/5 hover:bg-white/10 border border-white/10 text-white font-medium rounded-xl transition-all duration-300 flex items-center justify-center gap-3 group"
                            >
                        ...
                        >
                            <div className="relative">
                                ...
                                <div className="relative flex justify-center text-xs uppercase">
                                    <span className="bg-slate-900/80 px-2 text-gray-500">New here?</span>
                                </div>
                            </div>
                            ...
                            <p className="mt-4 text-sm text-gray-400 text-center">
                                ...
                                <Link
                                    ...
                                    className="text-white font-semibold hover:text-gray-300 transition-all underline"
                                >
                                    Register now
                                </Link>
                            </p>
